...
Array* func1(Array_param* vars, const unsigned long PATH0, int loopsFactor) {
   ...
   Array* array193;
   if (pCounter > 0) {
      array193 = vars->data.at(--pCounter);
      array193->refC++;
      ...
      array193->refC = 1;
      array193->id = 193;
      array193->data = std::vector<unsigned int>(array193->size, 0);
   ...
   if(PATH0 & 1) {
      ...
      params1.data.at(0) = array193;
      params1.data.at(1) = array194;

...
Array* func39(Array_param* vars, const unsigned long PATH0, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array82->refC = 1;
      array82->id = 82;
      array82->data = std::vector<unsigned int>(array82->size, 0);
   ...
   if(PATH0 & 1) {
      ...
      if (pCounter > 0) {
         ...
         array84->refC = 1;
         array84->id = 84;
         array84->data = std::vector<unsigned int>(array84->size, 0);
      ...
      params1.data.at(0) = array82;
      params1.data.at(1) = array83;

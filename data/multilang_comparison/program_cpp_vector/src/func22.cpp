...
Array* func22(Array_param* vars, const unsigned long PATH0, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array55->refC = 1;
      array55->id = 55;
      array55->data = std::vector<unsigned int>(array55->size, 0);
   ...
   for(; loop18 < loopLimit18; loop18++) {
      if(PATH0 & 1) {
         ...
         params0.data.at(0) = array55;
         params0.data.at(1) = array56;
      ...
      if(PATH0 & 2) {
         ...
         if (pCounter > 0) {
            ...
            array61->refC = 1;
            array61->id = 61;
            array61->data = std::vector<unsigned int>(array61->size, 0);
         ...
         params1.data.at(0) = array55;
         params1.data.at(1) = array59;
         params1.data.at(2) = array60;
         params1.data.at(3) = array61;

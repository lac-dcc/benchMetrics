...
array_t* func11(array_t_param* vars, const ulong PATH0, int loopsFactor) {
   size_t pCounter = vars.size;
   uint loop3 = 0;
   uint loopLimit3 = (50)/3 + 1;
   for(; loop3 < loopLimit3; loop3++) {
      if(PATH0 & 1) {
         ...
         if (pCounter > 0) {
            ...
            array5 = cast(array_t*)malloc(array_t.sizeof);
            array5.size = 736;
            array5.refC = 1;
            array5.id = 5;
            array5.data = cast(uint*)malloc(array5.size*uint.sizeof);
            memset(array5.data, 0, array5.size*uint.sizeof);
            DEBUG_NEW(array5.id);
         }
         uint loop4 = 0;
         uint loopLimit4 = (50)/4 + 1;
         ...
         params0.size = 0;
         params0.data = cast(array_t**)malloc(params0.size*(array_t*).sizeof);
         array_t* array34 = func22(&params0, get_path(), loopsFactor);
      ...
      if (pCounter > 0) {
         ...
         array43 = cast(array_t*)malloc(array_t.sizeof);
         array43.size = 618;
         array43.refC = 1;
         array43.id = 43;
         array43.data = cast(uint*)malloc(array43.size*uint.sizeof);
         memset(array43.data, 0, array43.size*uint.sizeof);
      ...
      if(PATH0 & 2) {
         ...
         if (pCounter > 0) {
            ...
            array47 = cast(array_t*)malloc(array_t.sizeof);
            array47.size = 193;
            array47.refC = 1;
            array47.id = 47;
            array47.data = cast(uint*)malloc(array47.size*uint.sizeof);
            memset(array47.data, 0, array47.size*uint.sizeof);
            DEBUG_NEW(array47.id);
         }
         uint loop16 = 0;
         uint loopLimit16 = (50)/4 + 1;
         ...
         array_t* array48 = func36(&params1, get_path(), loopsFactor);
         ...
         params1.data[0] = array43;
         params1.data[1] = array44;
         array_t* array58 = func32(&params1, get_path(), loopsFactor);
   ...
   if (pCounter > 0) {
      ...
      array64 = cast(array_t*)malloc(array_t.sizeof);
      array64.size = 725;
      array64.refC = 1;
      array64.id = 64;
      array64.data = cast(uint*)malloc(array64.size*uint.sizeof);
      memset(array64.data, 0, array64.size*uint.sizeof);

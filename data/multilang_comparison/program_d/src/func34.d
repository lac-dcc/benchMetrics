...
array_t* func34(array_t_param* vars, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array25 = cast(array_t*)malloc(array_t.sizeof);
      array25.size = 368;
      array25.refC = 1;
      array25.id = 25;
      array25.data = cast(uint*)malloc(array25.size*uint.sizeof);
      memset(array25.data, 0, array25.size*uint.sizeof);
      DEBUG_NEW(array25.id);
   }
   uint loop9 = 0;
   uint loopLimit9 = (50)/4 + 1;

...
array_t* func31(array_t_param* vars, const ulong PATH0, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array28 = cast(array_t*)malloc(array_t.sizeof);
      array28.size = 97;
      array28.refC = 1;
      array28.id = 28;
      array28.data = cast(uint*)malloc(array28.size*uint.sizeof);
      memset(array28.data, 0, array28.size*uint.sizeof);
   ...
   if(PATH0 & 1) {
      ...
      if (pCounter > 0) {
         ...
         array32 = cast(array_t*)malloc(array_t.sizeof);
         array32.size = 444;
         array32.refC = 1;
         array32.id = 32;
         array32.data = cast(uint*)malloc(array32.size*uint.sizeof);
         memset(array32.data, 0, array32.size*uint.sizeof);
         DEBUG_NEW(array32.id);
      }
      uint loop11 = 0;
      uint loopLimit11 = (50)/4 + 1;

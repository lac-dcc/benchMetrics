...
array_t* func0(array_t_param* vars, const ulong PATH0, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array1 = cast(array_t*)malloc(array_t.sizeof);
      array1.size = 386;
      array1.refC = 1;
      array1.id = 1;
      array1.data = cast(uint*)malloc(array1.size*uint.sizeof);
      memset(array1.data, 0, array1.size*uint.sizeof);
      DEBUG_NEW(array1.id);
   }
   uint loop1 = 0;
   uint loopLimit1 = (50)/2 + 1;
   for(; loop1 < loopLimit1; loop1++) {
      if(PATH0 & 1) {
         ...
         if (pCounter > 0) {
            ...
            array2 = cast(array_t*)malloc(array_t.sizeof);
            array2.size = 492;
            array2.refC = 1;
            array2.id = 2;
            array2.data = cast(uint*)malloc(array2.size*uint.sizeof);
            memset(array2.data, 0, array2.size*uint.sizeof);
            DEBUG_NEW(array2.id);
         }
         uint loop2 = 0;
         uint loopLimit2 = (50)/3 + 1;
         ...
         params0.data = cast(array_t**)malloc(params0.size*(array_t*).sizeof);
         params0.data[0] = array1;
         array_t* array109 = func4(&params0, get_path(), loopsFactor);
      ...
      if (pCounter > 0) {
         ...
         array119 = cast(array_t*)malloc(array_t.sizeof);
         array119.size = 326;
         array119.refC = 1;
         array119.id = 119;
         array119.data = cast(uint*)malloc(array119.size*uint.sizeof);
         memset(array119.data, 0, array119.size*uint.sizeof);
      ...
      if(PATH0 & 2) {
         ...
         if (pCounter > 0) {
            ...
            array123 = cast(array_t*)malloc(array_t.sizeof);
            array123.size = 872;
            array123.refC = 1;
            array123.id = 123;
            array123.data = cast(uint*)malloc(array123.size*uint.sizeof);
            memset(array123.data, 0, array123.size*uint.sizeof);
            DEBUG_NEW(array123.id);
         }
         uint loop37 = 0;
         uint loopLimit37 = (50)/3 + 1;
         ...
         array_t* array124 = func18(&params1, get_path(), loopsFactor);
         ...
         params1.data[1] = array119;
         params1.data[2] = array120;
         array_t* array146 = func14(&params1, get_path(), loopsFactor);

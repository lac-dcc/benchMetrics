...
array_t* func27(array_t_param* vars, const ulong PATH0, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array83 = cast(array_t*)malloc(array_t.sizeof);
      array83.size = 881;
      array83.refC = 1;
      array83.id = 83;
      array83.data = cast(uint*)malloc(array83.size*uint.sizeof);
      memset(array83.data, 0, array83.size*uint.sizeof);
   ...
   if(PATH0 & 1) {
      ...
      if (pCounter > 0) {
         ...
         array87 = cast(array_t*)malloc(array_t.sizeof);
         array87.size = 813;
         array87.refC = 1;
         array87.id = 87;
         array87.data = cast(uint*)malloc(array87.size*uint.sizeof);
         memset(array87.data, 0, array87.size*uint.sizeof);
         DEBUG_NEW(array87.id);
      }
      uint loop27 = 0;
      uint loopLimit27 = (50)/3 + 1;

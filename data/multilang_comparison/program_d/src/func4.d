...
array_t* func4(array_t_param* vars, const ulong PATH0, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array110 = cast(array_t*)malloc(array_t.sizeof);
      array110.size = 209;
      array110.refC = 1;
      array110.id = 110;
      array110.data = cast(uint*)malloc(array110.size*uint.sizeof);
      memset(array110.data, 0, array110.size*uint.sizeof);
      DEBUG_NEW(array110.id);
   }
   uint loop33 = 0;
   uint loopLimit33 = (50)/3 + 1;
   for(; loop33 < loopLimit33; loop33++) {
      if(PATH0 & 1) {
         ...
         if (pCounter > 0) {
            ...
            array111 = cast(array_t*)malloc(array_t.sizeof);
            array111.size = 581;
            array111.refC = 1;
            array111.id = 111;
            array111.data = cast(uint*)malloc(array111.size*uint.sizeof);
            memset(array111.data, 0, array111.size*uint.sizeof);
            DEBUG_NEW(array111.id);
         }
         uint loop34 = 0;
         uint loopLimit34 = (50)/4 + 1;
         ...
         array_t* array112 = func24(&params0, get_path(), loopsFactor);
         ...
         params0.data = cast(array_t**)malloc(params0.size*(array_t*).sizeof);
         params0.data[0] = array110;
         array_t* array113 = func16(&params0, get_path(), loopsFactor);
      ...
      if (pCounter > 0) {
         ...
         array114 = cast(array_t*)malloc(array_t.sizeof);
         array114.size = 769;
         array114.refC = 1;
         array114.id = 114;
         array114.data = cast(uint*)malloc(array114.size*uint.sizeof);
         memset(array114.data, 0, array114.size*uint.sizeof);
      ...
      if(PATH0 & 2) {
         ...
         if (pCounter > 0) {
            ...
            array116 = cast(array_t*)malloc(array_t.sizeof);
            array116.size = 850;
            array116.refC = 1;
            array116.id = 116;
            array116.data = cast(uint*)malloc(array116.size*uint.sizeof);
            memset(array116.data, 0, array116.size*uint.sizeof);
            DEBUG_NEW(array116.id);
         }
         uint loop35 = 0;
         uint loopLimit35 = (50)/4 + 1;
         ...
         array_t* array117 = func28(&params1, get_path(), loopsFactor);
         ...
         params1.data[1] = array114;
         params1.data[2] = array115;
         array_t* array118 = func22(&params1, get_path(), loopsFactor);

...
array_t* func17(array_t_param* vars, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array104 = cast(array_t*)malloc(array_t.sizeof);
      array104.size = 269;
      array104.refC = 1;
      array104.id = 104;
      array104.data = cast(uint*)malloc(array104.size*uint.sizeof);
      memset(array104.data, 0, array104.size*uint.sizeof);
   ...
   array_t* array105 = func24(&params0, get_path(), loopsFactor);
   DEBUG_RETURN(array105.id);
   free(params0.data);
   uint loop31 = 0;
   uint loopLimit31 = (50)/3 + 1;

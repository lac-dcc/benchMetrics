...
array_t* func13(array_t_param* vars, const ulong PATH0, int loopsFactor) {
   ...
   if (pCounter > 0) {
      ...
      array102 = cast(array_t*)malloc(array_t.sizeof);
      array102.size = 984;
      array102.refC = 1;
      array102.id = 102;
      array102.data = cast(uint*)malloc(array102.size*uint.sizeof);
      memset(array102.data, 0, array102.size*uint.sizeof);
   ...
   if(PATH0 & 1) {
      ...
      if (pCounter > 0) {
         ...
         array106 = cast(array_t*)malloc(array_t.sizeof);
         array106.size = 672;
         array106.refC = 1;
         array106.id = 106;
         array106.data = cast(uint*)malloc(array106.size*uint.sizeof);
         memset(array106.data, 0, array106.size*uint.sizeof);
         DEBUG_NEW(array106.id);
      }
      uint loop32 = 0;
      uint loopLimit32 = (50)/3 + 1;
      ...
      array_t* array107 = func28(&params1, get_path(), loopsFactor);
      ...
      params1.data[0] = array102;
      params1.data[1] = array103;
      array_t* array108 = func22(&params1, get_path(), loopsFactor);

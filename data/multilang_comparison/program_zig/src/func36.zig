...
pub fn func36(vars: *ArrayParam, _path0: u64) !*Array {
   ...
   if ((path0 & 1) != 0) {
      ...
      const array49 = try func37(&params0);
      defer allocator.free(params0.data);
      array49.refC -= 1;
      if (array49.refC == 0) {
          allocator.free(array49.data);
          allocator.destroy(array49);
      }
      ...
      const array51 = try func38(&params0, try get_path());
      defer allocator.free(params0.data);
      array51.refC -= 1;
      if (array51.refC == 0) {
   ...
   const array55 = try func39(&params0);
   defer allocator.free(params0.data);
   return array55;
}

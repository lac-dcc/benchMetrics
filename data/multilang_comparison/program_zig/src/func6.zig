...
pub fn func6(vars: *ArrayParam, _path0: u64) !*Array {
   ...
   if ((path0 & 1) != 0) {
      ...
      const array159 = try func7(&params0, try get_path());
      defer allocator.free(params0.data);
      array159.refC -= 1;
      if (array159.refC == 0) {
          allocator.free(array159.data);
          allocator.destroy(array159);
      }
      ...
      const array169 = try func8(&params0, try get_path());
      defer allocator.free(params0.data);
      array169.refC -= 1;
      if (array169.refC == 0) {
   ...
   const array174 = try func9(&params0, try get_path());
   defer allocator.free(params0.data);
   return array174;
}

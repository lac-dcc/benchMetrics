...
pub fn func18(vars: *ArrayParam, _path0: u64) !*Array {
   ...
   if ((path0 & 1) != 0) {
      ...
      const array125 = try func19(&params0, try get_path());
      ...
      const array135 = try func20(&params0, try get_path());
      defer allocator.free(params0.data);
      array135.refC -= 1;
      if (array135.refC == 0) {
   ...
   const array140 = try func21(&params0, try get_path());
   defer allocator.free(params0.data);
   return array140;
}

...
pub fn func27(vars: *ArrayParam, _path0: u64) !*Array {
   ...
   params0_data[0] = array179;
   var params0 = ArrayParam{
       .data = params0_data,
       .size = 1,
   };
   const array180 = try func33(&params0);
   ...
   if ((path0 & 1) != 0) {
      ...
      while (loop54 < loopLimit54) {
         ...
         for (0..array180.size) |i| {
             if (array180.data[i] == 71) {
                 return array180;
             }
         }
         loop54 += 1;
      ...
      params1_data[0] = array179;
      params1_data[1] = array180;
      params1_data[2] = array183;
      var params1 = ArrayParam{
          .data = params1_data,
          .size = 3,
      };
      const array184 = try func42(&params1, try get_path());
      ...
      array183.refC -= 1;
      if (array183.refC == 0) {
          allocator.free(array183.data);
          allocator.destroy(array183);
      }
      ...
      const array185 = try func34(&params1, try get_path());
      defer allocator.free(params1.data);
      array185.refC -= 1;
      if (array185.refC == 0) {

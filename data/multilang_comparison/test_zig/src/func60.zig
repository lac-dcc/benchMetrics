...
pub fn func60(vars: *ArrayParam, _path0: u64) !*Array {
   ...
   if ((path0 & 1) != 0) {
      ...
      const array21 = try func61(&params0);
      defer allocator.free(params0.data);
      array21.refC -= 1;
      if (array21.refC == 0) {
          allocator.free(array21.data);
          allocator.destroy(array21);
      }
      ...
      const array23 = try func62(&params0);
      defer allocator.free(params0.data);
      array23.refC -= 1;
      if (array23.refC == 0) {
          allocator.free(array23.data);
          allocator.destroy(array23);
      }
   }
   const params0_data = try allocator.alloc(*Array, 0);
   var params0 = ArrayParam{
   ...
   const array25 = try func63(&params0);
   defer allocator.free(params0.data);
   return array25;
}

...
pub fn func28(vars: *ArrayParam, _path0: u64) !*Array {
   ...
   if ((path0 & 1) != 0) {
      ...
      const array7 = try func29(&params0, try get_path());
      defer allocator.free(params0.data);
      array7.refC -= 1;
      if (array7.refC == 0) {
          allocator.free(array7.data);
          allocator.destroy(array7);
      }
      ...
      const array68 = try func30(&params0, try get_path());
      defer allocator.free(params0.data);
      array68.refC -= 1;
      if (array68.refC == 0) {
          allocator.free(array68.data);
          allocator.destroy(array68);
      }
   }
   const params0_data = try allocator.alloc(*Array, 0);
   var params0 = ArrayParam{
   ...
   const array104 = try func31(&params0, try get_path());
   defer allocator.free(params0.data);
   return array104;
}

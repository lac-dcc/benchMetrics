...
pub fn func36(vars: *ArrayParam, _path0: u64) !*Array {
   ...
   if ((path0 & 1) != 0) {
      ...
      const array128 = try func37(&params0, try get_path());
      ...
      const array138 = try func38(&params0, try get_path());
      defer allocator.free(params0.data);
      array138.refC -= 1;
      if (array138.refC == 0) {
   ...
   const array143 = try func39(&params0, try get_path());
   defer allocator.free(params0.data);
   return array143;
}

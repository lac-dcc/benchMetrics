...
pub fn func46(vars: *ArrayParam, _path0: u64) !*Array {
   ...
   if ((path0 & 1) != 0) {
      ...
      const array10 = try func47(&params0, try get_path());
      defer allocator.free(params0.data);
      array10.refC -= 1;
      if (array10.refC == 0) {
          allocator.free(array10.data);
          allocator.destroy(array10);
      }
      ...
      const array18 = try func48(&params0, try get_path());
      defer allocator.free(params0.data);
      array18.refC -= 1;
      if (array18.refC == 0) {
          allocator.free(array18.data);
          allocator.destroy(array18);
      }
   }
   const params0_data = try allocator.alloc(*Array, 0);
   var params0 = ArrayParam{
   ...
   const array30 = try func49(&params0, try get_path());
   defer allocator.free(params0.data);
   return array30;
}

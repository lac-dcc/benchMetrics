...
array_t* func2(array_t_param* vars, const unsigned long PATH0, int loopsFactor) {
   ...
   for(; loop53 < loopLimit53; loop53++) {
      if(PATH0 & 1) {
         ...
         array_t* array185 = func18(&params0, rng(), loopsFactor);
         ...
         params0.data = (array_t**)malloc(params0.size*sizeof(array_t*));
         params0.data[0] = array183;
         array_t* array186 = func14(&params0, rng(), loopsFactor);
      ...
      if(PATH0 & 2) {
         ...
         array_t* array190 = func24(&params1, rng(), loopsFactor);
         ...
         params1.data[1] = array187;
         params1.data[2] = array188;
         array_t* array191 = func16(&params1, rng(), loopsFactor);
